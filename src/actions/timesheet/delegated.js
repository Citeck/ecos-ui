...
export const getDelegatedDeputies = createAction(prefix + 'GET_DELEGATED_DEPUTIES');
export const setDelegatedDeputies = createAction(prefix + 'SET_DELEGATED_DEPUTIES');
