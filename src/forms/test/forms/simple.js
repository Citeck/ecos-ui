...
export default {
  ...
  form: {
    ...
    components: [
      {
        ...
        validate: { customPrivate: false, custom: '', pattern: '', maxLength: 10, minLength: 2, required: false },
        persistent: true,
        unique: false,
        protected: false,
        defaultValue: '',
      ...
      },
      {
        ...
        type: 'textfield',
        conditional: { eq: '', when: null, show: '' },
        validate: { customPrivate: false, custom: '', pattern: '', maxLength: '', minLength: '', required: false },
        persistent: true,
        unique: false,
        protected: false,
        defaultValue: '',
    ...
    submissionAccess: [
      ...
      { type: 'read_all', roles: ['58704bed7cc4b7006c4b8a6f'] },
      { type: 'update_all', roles: [] },
      { type: 'delete_all', roles: [] },
      { type: 'create_own', roles: ['58704bed7cc4b7006c4b8a6f'] },
      { type: 'read_own', roles: [] },
    ...
    access: [
      { type: 'create_all', roles: [] },
      { type: 'read_all', roles: ['58704bed7cc4b7006c4b8a6d', '58704bed7cc4b7006c4b8a6e', '58704bed7cc4b7006c4b8a6f'] },
      { type: 'update_all', roles: [] },
      { type: 'delete_all', roles: [] },
