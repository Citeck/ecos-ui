...
import Category from '@/components/editors/DesignerCommon/DesignerCategory';
import { REMOVE_DIALOG_ID } from '@/components/common/dialogs/Manager/DialogManager';
import {
  cancelEditCategory,
  createCategory,
...
const mapDispatchToProps = (dispatch, props) => ({
  ...
  saveEditableCategory: (code, mlText) => dispatch(saveCategoryRequest({ id: props.categoryId, code, label: mlText })),
