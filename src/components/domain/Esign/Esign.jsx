import { ErrorTypes, Labels, PLUGIN_URL } from '@citeck/constants/esign';
...
class EsignComponent extends Component {
  static propTypes = {
    recordRefs: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.string, PropTypes.object])).isRequired,
