...
const AiAssistant = ({ className, color = '' }: { className?: string; color?: string }) => {
  return (
    <svg className={className} width="16" height="16" fill={color || 'currentColor'} viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
