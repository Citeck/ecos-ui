...
export function InsertImageUploadedDialogBody({ onClick }) {
  ...
  return (
    <>
      <input type="file" label="Image Upload" onChange={loadImage} accept="image/*" data-test-id="image-modal-file-upload" />
      <input
        label="Alt Text"
              ...
              onClick(
                hasModifier.current
                  ? {
                      ...
                      src: 'https://avatars.mds.yandex.net/i?id=679720f2a94327342bb6a0e160ce7bb8_l-8497208-images-thumbs&n=13'
                    }
                  : {
                      altText: 'Yellow flower in tilt shift lens',
                      src: 'https://get.wallhere.com/photo/lake-mountain-tree-water-landscape-1076231.jpg'
                    }
              )
            }
          >
