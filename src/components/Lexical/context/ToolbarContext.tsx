...
import React, { JSX, createContext, ReactNode, useCallback, useContext, useEffect, useMemo, useState } from 'react';
...
export const blockTypeToBlockName = {
  bullet: 'lexical.plugins.toolbar.options-styles.bullet-list',
  check: 'lexical.plugins.toolbar.options-styles.check-list',
  code: 'lexical.plugins.toolbar.options-styles.code',
  h1: 'lexical.plugins.toolbar.options-styles.heading1',
  h2: 'lexical.plugins.toolbar.options-styles.heading2',
  h3: 'lexical.plugins.toolbar.options-styles.heading3',
  h4: 'lexical.plugins.toolbar.options-styles.heading4',
  h5: 'lexical.plugins.toolbar.options-styles.heading5',
