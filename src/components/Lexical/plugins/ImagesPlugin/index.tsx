...
export function InsertImageUriDialogBody({ onClick }: { onClick: (payload: InsertImagePayload) => void }) {
  ...
  return (
    <>
      <TextInput
        label={t('lexical.plugins.images.image-url')}
        placeholder={t('lexical.plugins.images.image-url.placeholder')}
        onChange={setSrc}
        value={src}
        data-test-id="image-modal-url-input"
      />
      <TextInput
        label={t('lexical.plugins.images.alt-text')}
        placeholder={t('lexical.plugins.images.alt-text.placeholder')}
        onChange={setAltText}
        value={altText}
...
export function InsertImageUploadedDialogBody({ onClick }: { onClick: (payload: InsertImagePayload) => void }) {
  ...
  return (
    <>
      <FileInput
        label={t('lexical.plugins.images.img-upload')}
        onChange={loadImage}
        accept="image/*"
      ...
      <TextInput
        label={t('lexical.plugins.images.alt-text')}
        placeholder={t('lexical.plugins.images.alt-text.alternative.placeholder')}
        onChange={setAltText}
        value={altText}
        data-test-id="image-modal-alt-text-input"
      />
