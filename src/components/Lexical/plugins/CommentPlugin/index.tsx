    ...
    <li className="CommentPlugin_CommentsPanel_List_Comment">
      <div className="CommentPlugin_CommentsPanel_List_Details">
        ...
        <span className="CommentPlugin_CommentsPanel_List_Comment_Time">
          · {seconds > -10 ? t('just-now') : rtf.format(minutes, 'minute')}
        </span>
      </div>
...
function CommentsPanel({
  ...
  return (
    <div className="CommentPlugin_CommentsPanel">
      <h2 className="CommentPlugin_CommentsPanel_Heading">{t('lexical.plugins.comment.comments')}</h2>
      {isEmpty ? (
        <div className="CommentPlugin_CommentsPanel_Empty">{t('lexical.plugins.comment.no-comments')}</div>
      ) : (
        <CommentsPanelList
          activeIDs={activeIDs}
          comments={comments}
    ...
    <>
      ...
      {createPortal(
        <Button
          ...
          title={showComments ? t('lexical.plugins.comment.hide-comments') : t('lexical.plugins.comment.show-comments')}
        >
