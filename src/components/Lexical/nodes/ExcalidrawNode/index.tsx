...
export class ExcalidrawNode extends DecoratorNode<JSX.Element> {
  ...
  decorate(editor: LexicalEditor, config: EditorConfig): JSX.Element {
    return <ExcalidrawComponent nodeKey={this.getKey()} data={this.__data} width={this.__width} height={this.__height} />;
  }
}

export function $createExcalidrawNode(data = '[]', width: Dimension = 'inherit', height: Dimension = 'inherit'): ExcalidrawNode {
