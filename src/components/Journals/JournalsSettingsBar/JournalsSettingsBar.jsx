...
import ExportIcon from '../../common/icons/global/Export';
import Filter from '../../common/icons/global/Filter';
import ImportIcon from '../../common/icons/global/Import';
import Repeat from '../../common/icons/global/Repeat';
import Setting from '../../common/icons/global/Setting';
import Shape from '../../common/icons/global/Shape';
    ...
    <>
      ...
      >
        ...
        <OverflowMenu isCollapsed={isCollapsed}>
          ...
          {!hidePresetsBtn && isViewNewJournal && !isMobile && (
