...
class JournalsDashletHeaderActions extends Component {
    ...
    return (
      <>
        ...
        <div className="ecos-journal-dashlet__group-actions">
          <GroupActions stateId={stateId} menuClassName="ecos-group-actions__dropdown-menu_widget" />
        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(JournalsDashletHeaderActions);
