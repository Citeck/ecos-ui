...
class ListDropdown extends React.Component {
  ...
  render() {
    const { isMobile, journalSettings = [], searchText, journalSetting, toggleClassName, className } = this.props;
    ...
    return (
      <div
        className={classNames('ecos-journal-menu__container', toggleClassName, {
          'ecos-journal-menu__container_mobile': isMobile
        })}
      >
        <Dropdown
          hasEmpty
        ...
        >
          <IcoBtn
            ...
            className={classNames(
              'ecos-journal__settings-bar-template-btn ecos-btn_hover_blue2 ecos-btn_drop-down ecos-btn_grey3 ecos-journal__btn_new template',
              {
                'ecos-journal__btn_new_selected': isNotDefaultSetting,
                'ecos-journal__btn_new_focus': isOpenDropdown
              }
            )}
          >
