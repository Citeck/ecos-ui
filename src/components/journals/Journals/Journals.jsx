import { DocLibUrlParams as DLUP, JournalUrlParams as JUP, SourcesId } from '@citeck/constants';
import { WidgetsKeys } from '@citeck/constants/widgets';
...
import JournalsPreviewWidgets from '@/components/journals/Journals/JournalsPreviewWidgets/JournalsPreviewWidgets';
...
class Journals extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.viewMode !== viewMode && (isTable(viewMode) || isKanban(viewMode) || isPreviewList(viewMode) || isDocLib(viewMode))) {
  ...
  renderWithWidgets = () => {
    const { widgetsConfig, stateId } = this.props;
    const { isLeftPositionWidgets } = widgetsConfig || {};
  ...
  render() {
    ...
    return (
      <ReactResizeDetector handleHeight={false} onResize={this.handleResize} targetRef={this._journalContainerRef}>
        <div
