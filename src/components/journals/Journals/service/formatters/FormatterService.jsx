...
class FormatterService {
  ...
  static _handleFormatter(type, useNewFormatter) {
    if (useNewFormatter && type === 'workflowPriority') {
  ...
  static _formatImpl(props = {}, formatter = {}) {
    const { row, cell, useNewFormatter = false } = props;
    ...
    const fmtInstance = this._handleFormatter(type, useNewFormatter);
