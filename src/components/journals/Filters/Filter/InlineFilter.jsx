import { getPredicates, PREDICATE_LIST_WITH_CLEARED_VALUES } from '@citeck/records-core/predicates/predicates';
...
class InlineFilter extends Filter {
  ...
  get selectedPredicate() {
    ...
    const fullPredicateInfo = get(
      predicates.filter(p => [predicate.value, predicate.t].includes(p.value)),
      [0],
      predicates[0]
    );
