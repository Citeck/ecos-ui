...
import { getPredicates, getPredicateValue, PREDICATE_TODAY } from '@citeck/records-core/predicates/predicates';
...
import { Label, Select } from '@/components/common/form';
import Columns from '@/components/common/templates/Columns/Columns';
...
export default class Filter extends Component {
  ...
  ValueControl = React.memo((props, context) => {
    ...
    if (isShow && EditorService.isRegistered(editorType)) {
      ...
      if (ControlComponent && isEqual(get(ControlComponent, 'props.value'), value)) {
