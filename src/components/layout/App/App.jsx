...
import EcosFormModal from '@/components/forms/EcosForm/EcosFormModal';
import { ErrorBoundary } from '@/components/common/ErrorBoundary';
import Header from '@/components/layout/Header';
import { MenuSettingsController } from '@/components/admin/MenuSettings';
import Notification from '@/components/common/Notification';
import PageTabs from '@/components/layout/PageTabs';
import CacheRoute, { CacheSwitch } from '@/components/common/ReactRouterCache';
import ReduxModal from '@/components/common/ReduxModal';
import Menu from '@/components/layout/Sidebar/Sidebar';
import { PopupContainer } from '@/components/common/Popper';
import UploadStatus from '@/components/common/UploadStatus';
import AIAssistantContainer from '@/components/ai/AIAssistant/AIAssistantContainer';
...
import { BASE_URLS_REDIRECT, Pages, pagesWithOnlyContent, RELOCATED_URL, URL as Urls } from '@citeck/constants';
import { allowedModes } from '@citeck/constants';
import { BASE_LEFT_MENU_ID, MenuTypes } from '@citeck/constants/menu';
import { PANEL_CLASS_NAME } from '@citeck/constants/pageTabs';
...
import PageLoader, { SidebarSkeleton } from '@/components/layout/PageLoader';
import Server from '@/components/common/icons/Server';
...
class App extends Component {
  ...
  renderCachedRouter = React.memo((props) => {
    ...
    const styles = tab.isActive ? undefined : { display: 'none' };
  ...
  renderRouter = () => {
    return (
      <div className="ecos-main-content">
        <Suspense fallback={<PageLoader withoutHeader withoutSidebar withoutTabsPanel />}>
          <Switch>
  ...
  render() {
    ...
    const appClassNames = classNames('app-container new', { mobile: isMobile });
    const basePageClassNames = classNames('app-content ecos-base-page ecos-base-page__new', {
