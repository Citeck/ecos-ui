...
import WorkspaceSwitcher from '@/components/common/icons/WorkspacesSwitcher';
...
import WorkspaceSidebar from '@/components/layout/WorkspaceSidebar/WorkspaceSidebar';
