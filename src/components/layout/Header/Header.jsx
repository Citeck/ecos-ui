  ...
  render() {
    ...
    return (
      <>
        ...
        <div
          ref={this._headerRef}
          className={classNames('ecos-header ecos-header_new', `ecos-header_theme_${theme}`, {
