...
import { DefaultImages } from '@citeck/constants/theme';
...
import SidebarToggle from '@/components/common/icons/SidebarToggle';
...
class Sidebar extends React.Component {
  ...
  render() {
    const { isOpen, isReady, largeLogoSrc, smallLogoSrc, items, id, workspace, isMobile } = this.props;
    ...
    return (
      <div
        id={id}
        className={classNames('ecos-sidebar ecos-sidebar_new', {
          'ecos-sidebar_expanded': isOpen,
          'ecos-sidebar_collapsed': !isOpen,
          'ecos-sidebar_new_expanded': isOpen,
          'ecos-sidebar_new_collapsed': !isOpen
        })}
      >
