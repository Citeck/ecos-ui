import { MAX_DEFAULT_HEIGHT_DASHLET, MIN_DEFAULT_HEIGHT_DASHLET } from '@citeck/constants';
...
import { Loader, Panel, ResizableBox } from '@/components/common';
...
class Dashlet extends Component {
  static propTypes = {
    ...
    linkTitleToGoTo: PropTypes.bool,
          ...
          header={
            !noHeader && (
              <Header
                ...
                linkTitleToGoTo={linkTitleToGoTo}
