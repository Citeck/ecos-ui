export default function() {
  ...
  function isIE() {
    var retVal =
      'Microsoft Internet Explorer' == navigator.appName || navigator.userAgent.match(/Trident\/./i); // IE < 11 // IE 11
    return retVal;
  }
  ...
  function load_npapi_plugin() {
    ...
    elem.setAttribute('style', 'visibility:hidden; height:0; width:0; position: absolute;');
