...
class CriptoProEsignComponent extends Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    Esign.initCriptoPro(props.recordRefs)
  ...
  getCertificates() {
    Esign.getCriptoProCertificates()
  ...
  handleSignDocument = selectedCertificate => {
    ...
    Esign.signDocumentCryptoPro(this.props.recordRefs, selectedCertificate, this.setSignatures)
...
export default CriptoProEsignComponent;
