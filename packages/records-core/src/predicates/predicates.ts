...
const getAllPredicates = function (): any[] {
  const { t } = getConfig().i18n;
  return [
...
export function getPredicate(value: any): any {
...
export function getPredicateValue(predicate: any): any {
  return predicate.t || predicate.value;
}

export function filterPredicates(filterArr: any[]): any[] {
...
export function getPredicates(field: any): any[] {
