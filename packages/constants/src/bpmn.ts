...
// An AI task backed by an agent is drawn with this instead of the plain AI icon: the agent runs
// tools unattended, so the diagram has to say so without opening the properties panel.
// Robot head, drawn in the same 30x30 box as the other ecos task icons. The eyes and the mouth are
// wound the opposite way from the head so the default nonzero fill rule punches them out as holes.
export const AI_AGENT_ICON_PATH =
  'M9,10 L21,10 A3,3 0 0 1 24,13 L24,23 A3,3 0 0 1 21,26 L9,26 A3,3 0 0 1 6,23 L6,13 A3,3 0 0 1 9,10 Z M13,17 A2,2 0 1 0 9,17 A2,2 0 1 0 13,17 Z M21,17 A2,2 0 1 0 17,17 A2,2 0 1 0 21,17 Z M18,21 L12,21 L12,23 L18,23 Z M14.25,6 L15.75,6 L15.75,10 L14.25,10 Z M13,4 A2,2 0 1 1 17,4 A2,2 0 1 1 13,4 Z M3,15 L6,15 L6,21 L3,21 Z M24,15 L27,15 L27,21 L24,21 Z'
